...
export default function TeatroPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Header - Mesmo cabeçalho da página de cinema */}
        ...
        <main className="bg-gradient-to-br from-gray-50 to-gray-100 text-gray-900 flex gap-6">
          ...
          <div className="flex-1 bg-white rounded-2xl p-6 flex flex-col items-center shadow-xl">
            ...
            <div className="w-full max-w-2xl space-y-4">
              {/* Palco */}
              <div className="bg-gray-500 py-8 rounded-2xl flex items-center justify-center shadow-lg border-2 border-gray-400">
                <span className="text-2xl font-bold tracking-wider text-gray-900">PALCO</span>
              </div>
          ...
          <div className="w-80 bg-white rounded-2xl p-6 flex flex-col shadow-xl">
            ...
            {selecionados.size === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center text-gray-500">
                <p className="text-center">Selecione uma área para começar sua reserva</p>
              </div>
            ) : (
              <>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  ...
                  <div className="flex gap-3">
                    {/* Botão Limpar - Vermelho mantido para ação destrutiva */}
                    <button onClick={limpar} className="flex-1 bg-red-500 hover:bg-red-600 px-4 py-3 rounded-lg font-semibold transition-colors text-white">
                      Limpar
                    </button>
                    {/* Botão Finalizar - Agora em azul padronizado */}
                    <button onClick={pagar} className="flex-1 bg-blue-600 hover:bg-blue-700 px-4 py-3 rounded-lg font-semibold transition-colors text-white">
                      Finalizar
                    </button>
                  </div>
                </div>
