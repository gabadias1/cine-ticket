...
export default function CinemaSeatsA() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.error('Erro ao buscar filme em assentos:', e);
      }
    })();
  }, [router.query]);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // fallback: se não existir na API (sessões sintéticas), usar o startsAt passado via query
        ...
        console.error('Erro ao buscar sessão em assentos:', e);
      }
    })();
  }, [router.query]);
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Header (padronizado com sessoes/[id].js) */}
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex space-x-8">
          <div className="flex-1 flex gap-8 p-6 text-gray-900 bg-white rounded-xl shadow-lg">
