...
export default function PageAssentos() {
    ...
    const layout = [
        ...
        ["A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A"],
        ["A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A"],
        ["A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "R", "R", "A", "A", "A"],
        ["A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A"],
        ["A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A", "A"],
    ];

    const fileiras = "ABCDEFGHIJ".split("");
    ...
    return (
        <div className="flex flex-col md:flex-row gap-8 p-6 text-white bg-gray-900 min-h-screen">
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-lg flex-1">
                {/* Tela */}
                <div className="bg-gray-700 text-center py-2 rounded-md mb-4 font-semibold">TELA</div>

                {/* Legenda */}
                <div className="flex justify-center gap-4 text-sm text-gray-400 mb-4">
                    <div className="flex items-center gap-2"><span className="w-4 h-4 bg-blue-500 rounded-sm"></span>Disponível</div>
                    <div className="flex items-center gap-2"><span className="w-4 h-4 bg-green-500 rounded-sm"></span>Selecionado</div>
                    <div className="flex items-center gap-2"><span className="w-4 h-4 bg-gray-500 rounded-sm"></span>Ocupado</div>
                </div>
          ...
          ${selecionado ? "bg-green-500 text-white" : "bg-blue-500 text-gray-900 hover:opacity-80"}`}
                                    >
                                        {j + 1}
                                    </div>
                                );
            ...
            {/* Painel lateral */}
            <div className="bg-gray-800 p-5 rounded-xl shadow-lg w-full md:w-72 flex-shrink-0">
                <h3 className="text-xl font-semibold mb-1">Reserva</h3>
                <p className="text-gray-400 mb-2">
                    {selecionados.size === 0 ? "Selecione uma poltrona" : `${selecionados.size} assento(s) selecionado(s)`}
                </p>
                ...
                <div className="flex gap-2 mt-4">
                    <button onClick={limpar} className="bg-red-500 hover:bg-red-600 px-3 py-1 rounded text-sm">Limpar</button>
                    <button onClick={pagar} className="bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded text-sm">Pagar</button>
                </div>
            </div>
        </div>
    );
